  ...
  return (
    <div className="page-container">
      ...
      <section className="about-section">
        <div className="container">
          <div className="about-content">
            ...
            <p data-aos="fade-up" data-aos-delay="200" data-aos-duration="800">We are a technology company based in Dubai, specializing in software solutions and digital services.</p>
            
            <div className="about-grid">
              <div className="about-text" data-aos="fade-up" data-aos-delay="300" data-aos-duration="800">
                <h2>Our Company</h2>
              ...
              <div className="about-image" data-aos="fade-left" data-aos-delay="400" data-aos-duration="1000">
                <img src="https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=500&h=350&fit=crop" alt="Team working" />
              </div>
            </div>

            <div className="company-stats">
              <div className="stat-item" data-aos="fade-up" data-aos-delay="500" data-aos-duration="800">
                <h3>6+</h3>
              ...
              <div className="stat-item" data-aos="fade-up" data-aos-delay="700" data-aos-duration="800">
                <h3>25+</h3>
                <p>Team Members</p>
              </div>
            </div>
      ...
      <section className="services-overview">
        <div className="container">
          <h2 data-aos="fade-up" data-aos-duration="1000">What We Do</h2>
          <div className="services-grid">
            <div className="service-item" data-aos="fade-up" data-aos-delay="100" data-aos-duration="800">
              <h3>Software Development</h3>
              <p>Custom software solutions tailored to your business needs.</p>
            </div>
            <div className="service-item" data-aos="fade-up" data-aos-delay="200" data-aos-duration="800">
              <h3>Web Applications</h3>
              <p>Modern web applications built with the latest technologies.</p>
            </div>
            <div className="service-item" data-aos="fade-up" data-aos-delay="300" data-aos-duration="800">
      ...
      <section className="contact-info-section">
        <div className="container">
          ...
          <div className="contact-grid">
            <div className="contact-item" data-aos="fade-up" data-aos-delay="100" data-aos-duration="800">
            ...
            <div className="contact-item" data-aos="fade-up" data-aos-delay="200" data-aos-duration="800">
              <span className="contact-icon">📧</span>
              <div>
                <h4>Email</h4>
      ...
      <section className="map-section">
        <div className="container">
          <h2 data-aos="fade-up" data-aos-duration="1000">Our Location</h2>
          <div className="map-container" data-aos="fade-up" data-aos-delay="200" data-aos-duration="800">
            <iframe 
